...
confs = [
  ...
  #toyota
  {'name': 'dp_toyota_sng', 'default': Truee, 'type': 'Bool', 'conf_type': ['param', 'struct']},
  ...
  #{'name': 'dp_following_profile', 'default': 1, 'type': 'UInt8', 'min': 0, 'max': 2, 'depends': [{'name': 'dp_following_profile_ctrl', 'vals': [True]}], 'conf_type': ['param', 'struct']},
