...
confs = [
  ...
  {'name': 'dp_lc_auto_min_mph', 'default': 65, 'type': 'UInt8', 'min': 0, 'max': 255, 'depends': [{'name': 'dp_lateral_mode', 'vals': [2]}], 'conf_type': ['param', 'struct']},
  {'name': 'dp_lc_auto_delay', 'default': 0.5, 'type': 'Float32', 'min': 0., 'max': 10., 'depends': [{'name': 'dp_lateral_mode', 'vals': [2]}], 'conf_type': ['param', 'struct']},
  {'name': 'dp_lane_less_mode_ctrl', 'default': True, 'type': 'Bool', 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_following_profile', 'default': 1, 'type': 'UInt8', 'min': 0, 'max': 3, 'depends': [{'name': 'dp_following_profile_ctrl', 'vals': [True]}], 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_temp_monitor', 'default': False, 'type': 'Bool', 'conf_type': ['param']},
  # UIs
  ...
  {'name': 'dp_ui_max_speed', 'default': False, 'type': 'Bool', 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_toyota_sng', 'default': True, 'type': 'Bool', 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_fan_mode', 'default': 1, 'type': 'UInt8', 'min': 0, 'max': 2, 'conf_type': ['param']},
  ...
  {'name': 'dp_prebuilt', 'default': True, 'type': 'Bool', 'conf_type': ['param']},
  {'name': 'dp_gpxd', 'default': False, 'type': 'Bool', 'conf_type': ['param']},
  ...
  {'name': 'dp_ftpd', 'default': True, 'type': 'Bool', 'conf_type': ['param']},
]
